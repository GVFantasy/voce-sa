...
import { startOnboarding, renderObProgress, showObStep, obNext, obBack, obToggleArea, obToggleChip, obToggleDay, obSingle, obSingleMeta, checkObStep2, generatePlan, obToggleIdioma, obSonoMeta, obEstudoMeta, showKickoff, startFromKickoff, kickoffToggleReminder, obIntroNext, obIntroSkip, obIntroGoto } from './onboarding.js';
...
import { renderPerfil, savePerfil, toggleIdioma, toggleDark, applyDarkIfSaved, exportCSV, exportJSON, saveReminder, toggleReminder, toggleWeeklySummary, scheduleReminder, initReminder, toggleSonoMeta, toggleTreinoDia, toggleEstudoDia, toggleRelacoesDia, toggleFinancasDia, toggleFinPerfil, saveFinMeta, changeEmail, changePassword, addCustomHabit, deleteCustomHabit, toggleCustomHabitDia, deleteAccount } from './profile.js';
...
window.obIntroNext = obIntroNext;
window.obIntroSkip = obIntroSkip;
window.obIntroGoto = obIntroGoto;
...
window.rwAddMateria = rwAddMateria;
window.rwRemoveMateria = rwRemoveMateria;
window.rwAddChecklist = rwAddChecklist;
window.rwRemoveChecklist = rwRemoveChecklist;
window.rwToggleDia = rwToggleDia;
window.rwSetDuracao = rwSetDuracao;
window.rwGenerate = rwGenerate;
window.rwRemoveBloco = rwRemoveBloco;
window.rwConfirm = rwConfirm;
window.toggleRotinaBloco = toggleRotinaBloco;
window.toggleRotinaChecklist = toggleRotinaChecklist;
window.encerrarRotina = encerrarRotina;
...
window.toggleWeeklySummary = toggleWeeklySummary;
